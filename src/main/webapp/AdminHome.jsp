<%-- 
    Document   : AdminHome
    Created on : 10 Dec 2020, 00:09:30
    Author     : samdo
--%>
						  ...
						  <a class="toggleMenu" href="#"><img src="images/nav.png" alt="" /></a>
						    <ul class="nav" id="nav">
						    	<li><a href="#">Hi ${SKUSER.firstName}</a></li>
                                                        <li><a href="#">User CRUD operations</a></li>
                                                        <li><a href="">Product CRUD operations</a></li>
                                                        <li><a href="#">Delivery charges operations</a></li>
                                                        <li><a href="#">Stock operations</a></li>
